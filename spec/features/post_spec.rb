...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do
      ...
      post_from_other_user = Post.create(date: Date.today, rationale: "This post shouldn't be seen", user_id: other_user.id, overtime_request: 3.0)
  ...
  describe 'delete' do
    it 'can be deleted' do
      ...
      post_to_delete = Post.create(date: Date.today, rationale: 'asdf', user_id: delete_user.id, overtime_request: 0.9)
  ...
  describe 'creation' do
    ...
    it 'will have a user associated it' do
      ...
      fill_in 'post[overtime_request]', with: 5.0
      click_on "Save"
